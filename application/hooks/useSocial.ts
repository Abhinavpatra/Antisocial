...
export function useUserSearch() {
  ...
  return { userId, query, setQuery: run, results, isLoading, error };
}
...
export function useFriends() {
  ...
  return { userId, friends, incoming, outgoing, isLoading, refetch, actions };
}
...
export function useLeaderboard() {
  ...
  return { userId, scope, setScope, range, setRange, rows, isLoading, refetch };
}
